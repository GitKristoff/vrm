            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex justify-between items-center mb-4">
                        <h3 class="text-lg font-medium">Your Pets</h3>
                        <div class="space-x-2">
                            <a href="{{ route('appointments.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">
                                New Appointment
                            </a>
                            <a href="{{ route('pets.create') }}" class="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700">
                                Add New Pet
                            </a>
                        </div>
                    </div>
                   ...
                   @if($pets->count())
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="text-sm text-gray-900">{{ $pet->species }}</div>
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <h3 class="mt-2 text-sm font-medium text-gray-900">No pets</h3>
                            <p class="mt-1 text-sm text-gray-500">You haven't registered any pets yet.</p>
                            <div class="mt-6">
